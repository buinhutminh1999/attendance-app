...
export const printDepartment = (department, groupedData) => {
  if (!groupedData || !groupedData[department]) {
    alert(`Không tìm thấy dữ liệu cho bộ phận: ${department}`);
    return;
  }
  ...
  if (!departmentData || departmentData.length === 0) {
    alert(`Dữ liệu của bộ phận: ${department} bị trống!`);
    return;
  }
